...
use Modules\Competition\Services\QuestionService;
use Modules\Competition\Services\QuizzesService;
...
class CompetitionServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(QuizzesServiceInterface::class, QuizzesService::class);
    }
